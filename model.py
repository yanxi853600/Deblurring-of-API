...
from SRN_finish.models.util import *
from SRN_finish.models.BasicConvLSTMCell import *
...
class DEBLUR(object):
        ...
        with tf.compat.v1.variable_scope(scope, reuse=reuse):
            with slim.arg_scope([slim.conv2d, slim.conv2d_transpose],
                ...
                for i in xrange(self.n_levels):
                    ...
                    inp_blur = tf.image.resize(inputs, [hi, wi], method=0)
    ...
    def train(self):
        ...
        for step in xrange(sess.run(global_step), self.max_steps + 1):
            ...
            if step % 5 == 0:
                # 每步樣本數num_examples_per_step為訓練批次大小
    ...
    def test(self, input):
        ...
        print('Image process time(s): ', duration)
        #print('Saving results: %s ... %4.3fs' % (os.path.join(output_path), duration))
